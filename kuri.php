...
* @copyright 2014-2021 Andrey Delfin
...
/**
* @param array $argv
* @return array Find console arguments
*/
...
/**
 * filtered function "_kuri"
 * @param string $currurl Url
 */
function _kuri($currurl = null){
...
* @return string Return 200 OK (html / json). Or return header 404 code
*/ 
function kuri($currurl = null, $prefix = '', $autotype = 'html'){
